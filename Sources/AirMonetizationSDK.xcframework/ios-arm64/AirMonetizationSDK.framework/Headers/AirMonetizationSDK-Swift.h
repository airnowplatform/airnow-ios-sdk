...
+ (AirMotetizationAd * _Nullable)inappBannerWithBannerSize:(CGSize)bannerSize SWIFT_WARN_UNUSED_RESULT;
/// Start working with inappBanner by creating it
/// with this class method.
/// @return Instantiated AirMonetizationInappBanner object ready to load.
+ (AirMotetizationAd * _Nullable)inappBannerWithBannerSize:(CGSize)bannerSize placementName:(NSString * _Nonnull)placementName SWIFT_WARN_UNUSED_RESULT;
...
+ (AirMotetizationAd * _Nullable)inlineBannerWithBannerView:(UIView * _Nonnull)bannerView withBannerSize:(CGSize)bannerSize SWIFT_WARN_UNUSED_RESULT;
/// Start working with Inline banner by creating it
/// with this class method.
/// Put your UIView and your UIViewController in ‘inlineBanner’ method.
/// For example: AirMonetizationInlileBanner.inlineBanner(bannerView: self.inAppBannerView, parentController: self)
/// @return Instantiated AirMonetizationInlileBanner object ready to load.
+ (AirMotetizationAd * _Nullable)inlineBannerWithBannerView:(UIView * _Nonnull)bannerView withBannerSize:(CGSize)bannerSize placementName:(NSString * _Nonnull)placementName SWIFT_WARN_UNUSED_RESULT;
